...
export function Header({ project }: { project: ProjectDetail }) {
  ...
  return (
    ...
    >
      <div className="w-full h-[300px] bg-gradient-to-r from-gray-900 to-gray-600">
        {project.hero_image_url && (
          <img
            src={project.hero_image_url || "/placeholder.svg"}
            alt={project.title}
            className="w-full h-full object-cover opacity-50"
          />
        )}
      </div>
      <div className="container mx-auto px-4 py-8 -mt-32 z-10">

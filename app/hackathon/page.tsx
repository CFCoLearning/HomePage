        ...
        <div className="min-h-[90vh] grid lg:grid-cols-2 gap-8 items-center py-12">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg md:text-xl text-white/80 max-w-xl">
              Join CFC Studio's innovative hackathon where creativity meets
              code. Transform your ideas into reality and compete with fellow
              developers in this exciting 120-hour（TODO） coding adventure.
            </p>
